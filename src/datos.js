...
const clientes = [
  {
    razon_social: "Price Hunter Asociados ARG / COL",
    nombre_cial_fantasia: "Price Hunter",
    cuit_nit_rut: "800123456",
    telefono: "3112546025",
    direccion_fiscal: "cra 5 este 47 - 49",
    ciudadId: 1,
    metodo_pago: "PSE",
    banco: "MERCADO PAGO",
    numero_cuenta: "954786321",
    tipoUsuarioId: 2,
    password: "phunter98756",
  },
  {
    razon_social: "Soy Henry",
    nombre_cial_fantasia: "Soy Henry",
    cuit_nit_rut: "800123654",
    telefono: "121465488",
    direccion_fiscal: "calle p no 85 - 12",
    ciudadId: 1,
    metodo_pago: "PSE",
    banco: "MERCADO PAGO",
    numero_cuenta: "987412545",
    tipoUsuarioId: 2,
    password: "soyhenry123",
  },
];
